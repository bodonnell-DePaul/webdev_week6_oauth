...
namespace TodoListApi.Migrations
{
    ...
    [Migration("20251014010520_AddAssignedToProperty")]
    partial class AddAssignedToProperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TodoListApi.Models.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            Category = "Academic",
                            CreatedDate = new DateTime(2025, 10, 11, 1, 5, 19, 867, DateTimeKind.Utc).AddTicks(4651),
                            Description = "Write and submit the final project proposal for CSC436",
                            DueDate = new DateTime(2025, 10, 25, 1, 5, 19, 867, DateTimeKind.Utc).AddTicks(4658),
                            IsCompleted = false,
                            Priority = "High",
                        ...
                        new
                        {
                            Id = "2",
                            Category = "Personal",
                            CreatedDate = new DateTime(2025, 10, 12, 1, 5, 19, 867, DateTimeKind.Utc).AddTicks(4688),
                            Description = "Buy groceries for the week including fruits and vegetables",
                            DueDate = new DateTime(2025, 10, 15, 1, 5, 19, 867, DateTimeKind.Utc).AddTicks(4689),
                            IsCompleted = true,
                            Priority = "Medium",
                        ...
                        new
                        {
                            Id = "3",
                            Category = "Work",
                            CreatedDate = new DateTime(2025, 10, 13, 1, 5, 19, 867, DateTimeKind.Utc).AddTicks(4701),
                            Description = "Prepare slides and agenda for the weekly team meeting",
                            DueDate = new DateTime(2025, 10, 18, 1, 5, 19, 867, DateTimeKind.Utc).AddTicks(4701),
                            IsCompleted = false,
                            Priority = "High",
                        ...
                        new
                        {
                            Id = "4",
                            Category = "Health",
                            CreatedDate = new DateTime(2025, 10, 14, 1, 5, 19, 867, DateTimeKind.Utc).AddTicks(4713),
                        ...
                        new
                        {
                            Id = "5",
                            Category = "Learning",
                            CreatedDate = new DateTime(2025, 10, 14, 1, 5, 19, 867, DateTimeKind.Utc).AddTicks(4728),
