...
namespace TodoListApi.Migrations
{
    ...
    [Migration("20251014004532_InitialCreate")]
            ...
            modelBuilder.Entity("TodoListApi.Models.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            Category = "Academic",
                            CreatedDate = new DateTime(2025, 10, 11, 0, 45, 31, 504, DateTimeKind.Utc).AddTicks(1134),
                            Description = "Write and submit the final project proposal for CSC436",
                            DueDate = new DateTime(2025, 10, 25, 0, 45, 31, 504, DateTimeKind.Utc).AddTicks(1142),
                            IsCompleted = false,
                            Priority = "High",
                        ...
                        new
                        {
                            Id = "2",
                            Category = "Personal",
                            CreatedDate = new DateTime(2025, 10, 12, 0, 45, 31, 504, DateTimeKind.Utc).AddTicks(1180),
                            Description = "Buy groceries for the week including fruits and vegetables",
                            DueDate = new DateTime(2025, 10, 15, 0, 45, 31, 504, DateTimeKind.Utc).AddTicks(1181),
                            IsCompleted = true,
                            Priority = "Medium",
                        ...
                        new
                        {
                            Id = "3",
                            Category = "Work",
                            CreatedDate = new DateTime(2025, 10, 13, 0, 45, 31, 504, DateTimeKind.Utc).AddTicks(1201),
                            Description = "Prepare slides and agenda for the weekly team meeting",
                            DueDate = new DateTime(2025, 10, 18, 0, 45, 31, 504, DateTimeKind.Utc).AddTicks(1201),
                            IsCompleted = false,
                            Priority = "High",
                        ...
                        new
                        {
                            Id = "4",
                            Category = "Health",
                            CreatedDate = new DateTime(2025, 10, 14, 0, 45, 31, 504, DateTimeKind.Utc).AddTicks(1218),
                        ...
                        new
                        {
                            Id = "5",
                            Category = "Learning",
                            CreatedDate = new DateTime(2025, 10, 14, 0, 45, 31, 504, DateTimeKind.Utc).AddTicks(1237),
